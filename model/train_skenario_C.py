"""
Training Script - Skenario C
Menggunakan ResNet50 (Sebagai Pembanding)
...
# KONFIGURASI
# ============================================================
IMG_SIZE = 224                          # Input size ResNet50
BATCH_SIZE = 32
EPOCHS_FROZEN = 20                      # Skenario C: 20 Epoch
EPOCHS_FINETUNE = 30                    # Skenario C: 30 Epoch
LEARNING_RATE_FROZEN = 1e-3
LEARNING_RATE_FINETUNE = 1e-5           # Skenario C: LR 1e-5
...
SAVE_DIR = os.path.join(BASE_DIR, 'saved_model', 'skenario_C')
...
def build_model(num_classes):
    """Bangun model ResNet50 dengan custom classification head."""
    print("\n🏗️  Building model...")
...
def train():
    ...
    print("   Model: ResNet50 (Sebagai Pembanding)")
    print("=" * 60)
