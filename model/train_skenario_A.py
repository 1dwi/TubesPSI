"""
Training Script - Skenario A
Menggunakan MobileNetV2 (Fixed Feature Extractor)
...
BATCH_SIZE = 32
EPOCHS_FROZEN = 30                      # Skenario A: 30 Epoch
EPOCHS_FINETUNE = 0                     # Skenario A: Tanpa fine-tuning
...
SAVE_DIR = os.path.join(BASE_DIR, 'saved_model', 'skenario_A')
